    ...
    <div className="min-h-screen p-6 bg-light-bg-100">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col gap-10 justify-between items-center mb-6">
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`px-4 py-1 rounded  bg-accent-100 hover:bg-accent-200 ${
                theme === "light" ? "ring-2 ring-border-100" : ""
              }`}
            >
              Light
            </button>
            <button
              ...
              className={`px-4 py-1 rounded  bg-accent-100 hover:bg-accent-200 ${
                theme === "rainbow" ? "ring-2 ring-border-100" : ""
              }`}
            >
              Rainbow
            </button>
            <button
              ...
              className={`px-4 py-1 rounded  bg-accent-100 hover:bg-accent-200 ${
                theme === "obsidian" ? "ring-2 ring-border-100" : ""
              }`}
            >
              Obsidian
            </button>
        ...
        <div className="flex flex-col gap-4 mt-2">
          ...
          {/* <button className="btn-full" onClick={() => navigate("/signup")}>
            signup
          </button> */}
          <button
            className="btn-full"
